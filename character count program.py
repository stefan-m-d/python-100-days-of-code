#this is a character count program

message='It was a bright cold day in April, and the clocks were striking thirteen.'
count = {}

for character in message.upper(): #the upper() method here is to have the program read the entire string as if it's uppercase letters, so we can see how many times each letter appears
    count.setdefault(character, 0) # if a character doesn't exist in the dictionary, one is created with a value of 0, this does nothing if the character already exists
...
import pprint
#use triple quotes to escape quotations in the text, this uses the entire Romeo and Juliet text
